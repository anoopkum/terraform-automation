...
def auto_commit_and_push():
    ...
    stdout, stderr = run_command("git push -u origin aiagent-demo")
    if stderr:
        logging.error(f"Git push error: {stderr}")
    else:
        print("Committed and pushed updated code to 'aiagent-demo' branch.")

    # Create a pull request using GitHub CLI
    pr_create_cmd = (
        "gh pr create --title 'Auto PR for Terraform update' "
        "--body 'Automated PR generated by Terraform AI Agent' --base main --head aiagent-demo"
    )
